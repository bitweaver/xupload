Post URL: <input type="text" name="url_post" value="{$smarty.server.PHP_SELF}">
<div class="row">
	{formlabel label="Upload Files"}
	{forminput}
<div id="slots"></div>
<input name="file1x" type="file" onChange="checkExt(this.value)"><br>
<input name="file2y" type="file"><br>
<input name="file3z" type="file"><br>
